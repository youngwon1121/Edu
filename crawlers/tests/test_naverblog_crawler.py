...
class NaverBlogCrawlerTest(TestCase):
    ...
    def test_get_listing_url(self):
        ...
        self.assertEqual(
            "https://blog.naver.com/PostTitleListAsync.naver?blogId=sntjdska123&from=postList&categoryNo=51&currentPage=1&countPerPage=10",
            url)
    ...
    def test_parse_index(self):
        ...
        # then
        self.assertEqual(
            'https://blog.naver.com/PostView.nhn?blogId=sntjdska123&from=postList&categoryNo=51&logNo=222991430176',
            urls[0])
    ...
    def test_parse_post(self):
        ...
        # when
        data = self.crawler._parse_post(html, 'https://blog.naver.com/PostView.nhn?blogId=sntjdska123&from=postList&categoryNo=51&logNo=222991430176')

        # then
        self.assertEqual(data['title'],
                         "[첨부파일] 수소차 관련주 (2030년까지 수소차 3만대 보급 , 수소 경제 정책 방향) 대창솔루션 / 평화홀딩스 / 대원강업 / 세종공업 / 평화산업")
